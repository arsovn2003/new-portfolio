        ...
        <>
            <div className="max-w-screen-xl text-white mx-auto p-4" id="services">
                <div className="mx-auto grid max-w-2xl grid-cols-1 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3 gap-5">
                    <div className="flex-col justify-center bg-neutral-800 duration-500 hover:bg-rose-800 p-10 cursor-pointer"
                        ...
                        <p className="mt-5 text-gray-400 leading-8">{servicesData.content1}</p>
                    </div>
                    <div className="flex-col justify-center bg-neutral-800 duration-500 hover:bg-rose-800 p-10 cursor-pointer"
                        ...
                        <p className="mt-5 text-gray-400 leading-8">{servicesData.content2}</p>
                    </div>
                    <div className="flex-col justify-center bg-neutral-800 duration-500 hover:bg-rose-800 p-10 cursor-pointer"
                        ...
                        <p className="mt-5 text-gray-400 leading-8">{servicesData.content3}</p>
                    </div>
                </div>
